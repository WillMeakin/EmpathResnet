...
def rnpa_bottleneck_layer(input_tensor, nb_filters, filter_sz, stage,
    ...
    # merge
    if use_shortcuts:
        x = add([x, input_tensor]) #merge([x, input_tensor], mode='sum', name=merge_name)
...
def ResNetPreAct(input_shape=(48, 48, 1), nb_classes=7,
    ...
    """
    This module by Jeffrey Price: https://gist.github.com/JefferyRPrice/c1ecc3d67068c8d9b3120475baba1d7e
    ...
    img_input = Input(shape=input_shape, name='fer')
    ...
    return Model(inputs=img_input, outputs=x, name='rnpa')